...
<div class="breadcrumb row">
    <div class="col-md-8">
        ...
        <ul>
            ...
            <li>Production List</li>
        </ul>
    </div>
    <div class="col-md-4 text-right">
        <a href="{{ route('admin.user.production.create') }}" class="btn btn-primary">Create Production</a>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12">
        <div class="card text-left">
            <div class="card-body">
                <h4 class="card-title mb-3">Production Details</h4>
                    ...
                    <table class="display table table-striped table-bordered" id="zero_configuration_table" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn {{ $users->is_employee == 1 ? 'btn-dark' : 'btn-light' }} btn-sm">{{$users->get_role()}}</button>
                                </td>
                                <td>
                                    @if($users->category != null)
                                    @foreach($users->category as $categorys)
                                    <button class="btn btn-info btn-sm">{{$categorys->name}}</button>
                                    @endforeach
                                    @endif
                                </td>
                                <td>{{$users->email}}</td>
                                ...
                                <td>
                                    <button class="btn btn-danger btn-sm update-password" data-id="{{$users->id}}">Reset Password</button>
                                </td>
                                <td>
