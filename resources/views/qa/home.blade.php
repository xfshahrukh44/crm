                ...
                <div class="card-body">
                    ...
                    @foreach($recent_tasks as $recent_task)
                        <div class="d-flex align-items-center border-bottom-dotted-dim pb-3 mb-3">
                            <img class="avatar-md rounded mr-3" src="{{ asset('newglobal/images/no-user-img.jpg') }}" alt="{{ $recent_task->user->name }} {{ $recent_task->user->last_name }}" />
            ...
            <div class="card mb-2">
                <div class="card-body" style="max-height: 350px; overflow-y: scroll;">
                    ...
                    @foreach($todays_tasks as $todays_task)
                        <div class="d-flex align-items-center border-bottom-dotted-dim pb-3 mb-3">
                            <img class="avatar-md rounded mr-3" src="{{ asset('newglobal/images/no-user-img.jpg') }}" alt="{{ $todays_task->user->name }} {{ $todays_task->user->last_name }}" />
                            <div class="flex-grow-1">
