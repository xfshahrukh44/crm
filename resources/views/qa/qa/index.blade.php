...
<div class="breadcrumb row">
    ...
    <div class="col-md-4 text-right">
        <a href="{{ route('qa.user.qa.create') }}" class="btn btn-primary">Create QA</a>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12">
        <div class="card text-left">
            <div class="card-body">
                <h4 class="card-title mb-3">QA Details</h4>
...
{{--                                </td>--}}
                                ...
                                <td>
                                    <a href="{{route('qa.user.qa.edit', $users->id)}}" class="btn btn-primary btn-icon btn-sm">
