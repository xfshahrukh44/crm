...
<div class="side-content-wrap">
    <div class="sidebar-left open rtl-ps-none" data-perfect-scrollbar="" data-suppress-scroll-x="true">
        <ul class="navigation-left">
            ...
            @else
                <li class="nav-item {{ ( request()->routeIs('billing.client.index') || request()->routeIs('billing.client.create') || request()->routeIs('billing.generate.payment') || request()->routeIs('billing.client.edit')) ? 'active' : '' }}">
                    <a class="nav-item-hold" href="{{ route('billing.client.index') }}">
                        <i class="nav-icon i-Add-User"></i>
                        <span class="nav-text">Clients</span>
                    </a>
                    <div class="triangle"></div>
                </li>
                <li class="nav-item {{ (request()->routeIs('billing.invoice')) || (request()->routeIs('billing.invoice.edit')) || (request()->routeIs('billing.link')) ? 'active' : '' }}">
                    <a class="nav-item-hold" href="{{ route('billing.invoice') }}">
