...
<div class="row mb-4">
    <div class="col-md-12">
        <div class="card text-left">
            <div class="card-body">
                <form action="{{ route('support.invoice') }}" method="GET">
                    <div class="row">
...
{{--                                    <span class="btn btn-{{ App\Models\Invoice::STATUS_COLOR[$datas->payment_status] }} btn-sm">--}}
                                    <span class="">
                                        ...
                                        @if($datas->payment_status == 1)
                                            <form method="post" action="{{ route('support.invoice.paid', $datas->id) }}">
                                                @csrf
                                ...
                                <td>
                                    <div class="d-flex">
                                        @if($datas->payment_status == 1)
                                        <a href="{{ route('support.invoice.edit', $datas->id) }}" class="btn btn-primary btn-icon btn-sm mr-1">
                                            <span class="ul-btn__icon"><i class="i-Edit"></i></span>
                                            <span class="ul-btn__text">Edit</span>
                                        </a>
                                        @endif
                                        <a href="{{ route('support.link', $datas->id) }}" class="btn btn-info btn-icon btn-sm">
