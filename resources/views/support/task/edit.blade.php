    ...
    <div class="col-md-12">
        <div class="card mb-4">
            <div class="card-body">
                ...
                <form class="form" action="{{route('update.task.by.support', $task->id)}}" method="POST" enctype="multipart/form-data" id="create-task">
                    @csrf
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-4 form-group mb-3">
                                <label for="project">Select Project <span>*</span></label>
                                <input type="text" name="project_name" id="project_name" class="form-control" value="{{ $task->projects->name }}" readonly>
                            </div>
                            <div class="col-md-4 form-group mb-3">
...
{{--                                <select name="category[]" id="category" class="form-control select2" required multiple>--}}
                            ...
                            <div class="col-md-4 form-group mb-4">
                                ...
                                <input class="form-control" type="date" name="duedate" id="duedate" value="{{$task->duedate}}" required>
                            </div>
                            ...
                            <div class="col-md-12">
                                <button class="btn btn-primary create-task-btn" type="submit">Update Task</button>
                            </div>
                        </div>
                    </div>
                </form>
