            ...
            <div class="col-md-12">
                <div class="card text-left mb-4">
                    <div class="card-body">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="task-overview-tab" data-toggle="tab"
                                   href="#task-overview" role="tab" aria-controls="task-overview" aria-selected="true">Task
                                    Overview</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="message-show-tab" data-toggle="tab" href="#message-show"
                                   role="tab" aria-controls="message-show" aria-selected="false">Message</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="notes-tab" data-toggle="tab" href="#notes-show" role="tab"
                                   aria-controls="notes-show" aria-selected="false">Notes</a>
                            </li>
                            @if(count($task->qa_feedbacks))
                                <li class="nav-item">
                                    <a class="nav-link" id="qa-tab" data-toggle="tab" href="#qa-show" role="tab"
                                       aria-controls="qa-show" aria-selected="false">QA Feedback</a>
                                </li>
                            @endif
                        </ul>
                    </div>
                ...
                <div class="" id="myTabContent">
                    <div class="tab-pane fade show active" id="task-overview" role="tabpanel"
                         aria-labelledby="task-overview-tab">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card mb-4">
                                    <div class="card-body">
                                        ...
                                        <ul class="task_main_list">
                                            ...
                                            <li>
                                                <div class="task_main_list-wrapper">
                                                    <p>Due Date: {{ date('d M, y', strtotime($task->duedate)) }} |
                                                        Created At: {{ $task->created_at->format('d M, y h:i a') }}</p>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body pl-0 pr-0">
                                        ...
                                        @if(count($task->client_files_support))
                                            <button type="button"
                                                    class="btn-primary btn-sm btn_download_all_files ml-4 mb-4">Download
                                                all files
                                            </button>
                                        @endif
                                        <div class="separator-breadcrumb border-top mb-3"></div>
                                        <div class="table-responsive">
                                            <table class="display table table-striped table-bordered files"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @if(($extension == 'jpg') || ($extension == 'png') || (($extension == 'jpeg')))
                                                                <a href="{{asset('files/'.$client_files->path)}}"
                                                                   target="_blank">
                                                                    <img src="{{asset('files/'.$client_files->path)}}"
                                                                         alt="{{$client_files->name}}" width="100">
                                                                </a>
                                                            @else
                                                                <a href="{{asset('files/'.$client_files->path)}}"
                                                                   target="_blank">
                                                        ...
                                                        <td>
                                                            <button class="btn btn-secondary btn-sm">{{$client_files->user->name}} {{$client_files->user->last_name}}</button>
                                                        </td>
                                                        <td>
                                                            <button class="btn btn-primary btn-sm">{{$client_files->created_at->format('d M, y') }}</span>
                                                        </td>
                                                        <td>
                                                            <div class="btn-group float-md-right ml-1">
                                                                ...
                                                                <div class="dropdown-menu arrow">
                                                                    <a class="dropdown-item"
                                                                       href="{{asset('files/'.$client_files->path)}}"
                                                                       target="_blank"> View</a>
                                                                    <a class="dropdown-item anchor_test"
                                                                       href="{{asset('files/'.$client_files->path)}}"
                                                                       download> Download</a>
                            ...
                            <div class="col-md-6">
                                <div class="card mb-4">
                                    <div class="card-body">
                                        ...
                                        <div class="separator-breadcrumb border-top mb-3"></div>
                                        <form class="form" action="{{route('support.subtask.store')}}" method="POST"
                                                            ...
                                                            @if($sub_tasks->duedate != null)
                                                                ...
                                                                {{ date('d M, y', strtotime($sub_tasks->duedate)) }}
                                                                    ...
                                                                    @if($sub_tasks->duedateChange != null)
                                                                        <div class="right"
                                                                             style="border-left: 1px solid #e5e5e5;padding-left: 15px;text-align: left;">
                                                                    ...
                                                                    <div class="ul-widget3-header">
                                                                        <div class="ul-widget3-img">
                                                                            @if($subtask_message->user->image != '')
                                                                                <img id="userDropdown"
                                                                                     src="{{ asset($subtask_message->user->image) }}"
                                                                                     alt="" data-toggle="dropdown"
                                                                                     aria-haspopup="true"
                                                                                     aria-expanded="false">
                                                                            @else
                                        ...
                                        <form action="{{ route('store.notes.by.support') }}" id="additional-notes">
                                            ...
                                            <div class="form-group">
                                                <textarea name="notes" id="notes" cols="30" rows="5"
                                                          class="form-control" required>{{ $task->notes }}</textarea>
                                            </div>
                                            <div class="form-actions pb-0 text-right">
                    ...
                    @if(count($task->qa_feedbacks))
                        <div class="tab-pane fade" id="qa-show" role="tabpanel"
                             aria-labelledby="qa-show-tab">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card mb-4">
                                                ...
                                                <div class="row" id="feedback_wrapper_row">
                                                    <div class="col-md-4 p-0">
                                                        <button type="submit" name="status"
                                                                value="0"
                                                                class="btn btn-{!! $qa_feedback->status == '3' ? 'success' : 'danger' !!} mx-3">{{get_task_status_text($qa_feedback->status)}}</button>
                                                    </div>
                                                    <div class="col-md-4">
                                                            ...
                                                            <div class="row">
                                                                    ...
                                                                    <label for="">
                                                                        <b class="text-15">
                                                                            ...
                                                                            @if(count($qa_feedback->qa_files) > 1)
                                                                                <a href="#"
                                                                                   class="anchor_download__all_qa_files">
                                                                                    <small>(Download
                                                                                        all)</small>
                                                                                </a>
                                                                            @endif
                                                                ...
                                                                <ul>
                                                                    @foreach($qa_feedback->qa_files as $qa_file)
                                                                        <li>
                                                                            <a class="anchor_download_qa_file"
                                                                               download
                                                                               href="{{asset($qa_file->path)}}">{{$qa_file->name}}</a>
                                                                        </li>
                                                                    @endforeach
                                                                </ul>
                                                            </div>
            ...
            <form class="form" action="{{ route('support.message.send') }}" enctype="multipart/form-data" method="post"
                ...
                <div class="form-body">
                    <div class="form-group mb-0">
                        <h1>Write A Message <span id="close-message-left"><i class="nav-icon i-Close-Window"></i></span>
                        </h1>
                        <textarea id="message" rows="8" class="form-control border-primary" name="message" required
