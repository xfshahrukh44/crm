...
<div class="breadcrumb row">
    ...
    <div class="col-md-6 text-right">
        <a href="{{ route('billing.client.create') }}" class="btn btn-primary">Create Client</a>
    </div>
</div>
...
<div class="row mb-4">
    <div class="col-md-12">
        <div class="card text-left">
            <div class="card-body">
                <form action="{{ route('billing.client.index') }}" method="GET">
                    <div class="row">
                    ...
                    <table class="display table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{ route('billing.generate.payment', $datas->id) }}" class="btn btn-primary btn-sm">Generate Payment</a></td>
                                <td>
                                    @if($datas->status == 1)
                                ...
                                <td>
                                    <a href="{{route('billing.client.edit', $datas->id)}}" class="btn btn-primary btn-icon btn-sm">
