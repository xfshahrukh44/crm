    ...
    <div class="col-md-12">
        <div class="card mb-4">
            <div class="card-body">
                ...
                <form class="form" action="{{route('manager.lead.update', $data->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group mb-3">
                                ...
                                <select name="user_id" id="user_id" class="form-control select2">
                                    @foreach($front_agents as $front_agent)
                                        <option value="{{ $front_agent->id }}" {!! $data->user_id == $front_agent->id ? 'selected' : '' !!}>{{ $front_agent->name . ' ' . $front_agent->last_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-12">
