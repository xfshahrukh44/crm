...
<div class="breadcrumb row">
    ...
    <div class="col-md-6 text-right">
        <a href="{{ route('manager.lead.create') }}" class="btn btn-primary">Create Lead</a>
    </div>
</div>
...
<div class="row mb-4">
    <div class="col-md-12">
        <div class="card text-left">
            <div class="card-body">
                <form action="{{ route('manager.lead.index') }}" method="GET">
                    <div class="row">
                    ...
                    <table class="display table table-striped table-bordered"  style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('manager.lead.edit', $datas->id) }}" class="btn btn-primary btn-icon btn-sm">
                                        <span class="ul-btn__icon"><i class="i-Edit"></i></span>
                                        <span class="ul-btn__text">Edit</span>
                                    </a>
                                    <a href="{{ route('manager.lead.show', $datas->id) }}" class="btn btn-dark btn-icon btn-sm">
                                        <span class="ul-btn__icon"><i class="i-Eyeglasses-Smiley"></i></span>
                                        <span class="ul-btn__text">View</span>
                                    </a>
                                    <form method="POST" action="{{route('manager.lead.destroy', $datas->id) }}">
                                        {{ method_field('DELETE') }}
                                        {{ csrf_field() }}
