...
<div class="breadcrumb row">
    ...
    <div class="col-md-4 text-right">
        <a href="{{ route('manager.user.sales.create') }}" class="btn btn-primary">Create Agent</a>
    </div>
</div>
                    ...
                    <table class="display table table-striped table-bordered" id="zero_configuration_table" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('manager.user.sales.edit', $users->id)}}" class="btn btn-primary btn-icon btn-sm">
