            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 form-group mb-3">
                        ...
                        <input class="form-control" name="facebook_page" id="facebook_page" type="text" value="{{ old('facebook_page', $smm_form->facebook_page) }}" required/>
                    </div>
                    <div class="col-md-6 form-group mb-3">
                        <label for="instagram_page">Link to Instagram Page</label>
                        <input class="form-control" name="instagram_page" id="instagram_page" type="text" value="{{ old('instagram_page', $smm_form->instagram_page) }}" required/>
                    </div>
                    <div class="col-md-6 form-group mb-3">
                        <label for="instagram_password">Instagram Password</label>
                        <input class="form-control" name="instagram_password" id="instagram_password" type="text" value="{{ old('instagram_password', $smm_form->instagram_password) }}" required/>
                    </div>
                    <div class="col-md-6 form-group mb-3">
                        <label for="twitter_page">Link to Twitter Page</label>
                        <input class="form-control" name="twitter_page" id="twitter_page" type="text" value="{{ old('twitter_page', $smm_form->twitter_page) }}" required/>
                    </div>
                    <div class="col-md-6 form-group mb-3">
                        <label for="twitter_password">Twitter Password</label>
                        <input class="form-control" name="twitter_password" id="twitter_password" type="text" value="{{ old('twitter_password', $smm_form->twitter_password) }}" required/>
                    </div>
                    <div class="col-md-12 form-group mb-3">
                        <label for="linkedin_page">Link to LinkedIn Page</label>
                        <input class="form-control" name="linkedin_page" id="linkedin_page" type="text" value="{{ old('linkedin_page', $smm_form->linkedin_page) }}" required/>
                    </div>
                    <div class="col-md-6 form-group mb-3">
                        <label for="pinterest_page">Link to Pinterest Page</label>
                        <input class="form-control" name="pinterest_page" id="pinterest_page" type="text" value="{{ old('pinterest_page', $smm_form->pinterest_page) }}" required/>
                    </div>
                    <div class="col-md-6 form-group mb-3">
                        <label for="pinterest_password">Pinterest Password</label>
                        <input class="form-control" name="pinterest_password" id="pinterest_password" type="text" value="{{ old('pinterest_password', $smm_form->pinterest_password) }}" required/>
                    </div>
                    <div class="col-md-12 form-group mb-3">
                        <label for="youtube_page">Link to YouTube Page</label>
                        <input class="form-control" name="youtube_page" id="youtube_page" type="text" value="{{ old('youtube_page', $smm_form->youtube_page) }}" required/>
                    </div>
                    <div class="col-md-6 form-group mb-3">
                        <label for="gmail_address_youtube">Gmail Address for YouTube</label>
                        <input class="form-control" name="gmail_address_youtube" id="gmail_address_youtube" type="text" value="{{ old('gmail_address_youtube', $smm_form->gmail_address_youtube) }}" required/>
                    </div>
                    <div class="col-md-6 form-group mb-3">
                        <label for="gmail_password_youtube">Gmail Password for YouTube</label>
                        <input class="form-control" name="gmail_password_youtube" id="gmail_password_youtube" type="text" value="{{ old('gmail_password_youtube', $smm_form->gmail_password_youtube) }}" required/>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12 form-group mb-3">
                        ...
                        <input class="form-control" name="target_locations" id="target_locations" type="text" value="{{ old('target_locations', $smm_form->target_locations) }}" />
                    </div>
                    <div class="col-md-12 form-group mb-3">
                        @php
                    ...
                    <div class="col-md-6 form-group mb-3">
                        ...
                        <input class="form-control" name="age_bracket" id="age_bracket" type="text" value="{{ old('age_bracket', $smm_form->age_bracket) }}" />
                    </div>
                    <div class="col-md-12 form-group mb-3">
                        <label for="represent_your_business">Please mention keywords or online interests that best represent your audience</label>
                        <textarea class="form-control" name="represent_your_business" id="represent_your_business">{{ old('represent_your_business', $smm_form->represent_your_business) }}</textarea>
                    </div>
                    <div class="col-md-12 form-group mb-3">
                        <label for="business_usp">What is your business USP (Unique Selling Points)?</label>
                        <textarea class="form-control" name="business_usp" id="business_usp">{{ old('business_usp', $smm_form->business_usp) }}</textarea>
                    </div>
                    <div class="col-md-12 form-group mb-3">
                        ...
                        <textarea class="form-control" name="do_not_want_us_to_use" id="do_not_want_us_to_use">{{ old('do_not_want_us_to_use', $smm_form->do_not_want_us_to_use) }}</textarea>
                    </div>
                    <!-- <div class="col-md-12 form-group mb-3">
                        <label for="competitors">Share pages of your competitors or other brands you are most inspired by</label>
                        <textarea class="form-control" name="competitors" id="competitors">{{ old('competitors', $smm_form->competitors) }}</textarea>
                    </div> -->
