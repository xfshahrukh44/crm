...
@section('content')
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="brief-info">
                                    <h2 class="mt-4">Brand Form</h2>
                                    <form action="{{route('v2.brands.store')}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-4">
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="phone_tel" value="{{old('phone_tel') ?? ''}}" required>
                                                    @error('phone_tel')
                                                    <label class="text-danger">{{ $message }}</label>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="address_link" value="{{old('address_link') ?? ''}}" required>
                                                    @error('address_link')
                                                    <label class="text-danger">{{ $message }}</label>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2" name="sign" id="sign">
                                                        <option value="$" {{ request()->get('sign') ==  "$" ? 'selected' : ' '}}>$ - Dollar</option>
                                                        <option value="£" {{ request()->get('sign') ==  "£" ? 'selected' : ' '}}>£ - Euro</option>
                                                    </select>
                                                    @error('sign')
                                                    <label class="text-danger">{{ $message }}</label>
                                                    @enderror
    ...
    <!-- External Brand Modal -->
    <div class="modal fade" id="externalBrandModal" tabindex="-1" role="dialog" aria-labelledby="externalBrandModalTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="#" type="button" class="btn btn-primary" id="btn_edit_external_brand">Edit Brand</a>
                </div>
            </div>
        </div>
    </div>
