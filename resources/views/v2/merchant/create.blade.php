                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="brief-info">
                                    ...
                                    <form action="{{route('v2.merchants.store')}}" method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <select name="is_authorized" id="is_authorized" class="form-control">
                                                        ...
                                                        <option value="1" {!! old('is_authorized') == "1" ? 'selected' : '' !!}>Stripe</option>
                                                        <option value="2" {!! old('is_authorized') == "2" ? 'selected' : '' !!}>Authorize.net</option>
                                                    </select>
                                                    @error('is_authorized')
                                                    <label class="text-danger">{{ $message }}</label>
                                                    @enderror
