                    ...
                    <div class="col-md-12">
                        <div class="list-0f-head for-invoice-listing table-responsive">
                            ...
                            <form class="search-invoice" action="{{ route('v2.invoices.refund.cb') }}" method="GET">
                                <input type="text" name="invoice_number" placeholder="Search invoice number"
                                    value="{{ request()->get('invoice_number') }}">
                                <input step=".01" type="number" id="refunded_cb" class="form-control"
                                    placeholder="Refunded CB" name="refunded_cb"
                                    value="{{ request()->get('invoice_number') }}">
                                <input type="date" id="refund_cb_date" class="form-control"
                                    placeholder="Refunded CB date" name="refund_cb_date"
                                    value="{{ request()->get('refund_cb_date') ? \Carbon\Carbon::parse(request()->get('refund_cb_date'))->format('Y-m-d') : '' }}">
                                ...
                                <tbody>
                                    @foreach ($invoices as $invoice)
                                        <tr>
                                            ...
                                            <td>{{ $invoice->sale->name ?? '' }} {{ $invoice->sale->last_name ?? '' }}
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                @for ($i = 0; $i < count($service_list); $i++)
                                                    @if ($service_list[$i])
                                                        ...
                                                        @endfor
                                                        <span
                                                            class="badge badge-info badge-sm p-2 mb-1">{{ $service_list_name }}</span>
                                                    @endif
                                                @endfor
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-danger">
                                                {{ \Carbon\Carbon::parse($invoice->refund_cb_date)->format('d M y') }}</td>
                                            <td>
