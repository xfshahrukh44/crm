                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="is_employee" id="is_employee" required>
                                                ...
                                                <option value="9" {!! old('is_employee') == "9" ? 'selected' : '' !!}>PPC</option>
                                            </select>
                                            @error('is_employee')
                                            <label class="text-danger">{{ $message }}</label>
                                            @enderror
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="merchant[]" id="merchant" multiple>
                                                    @foreach($merchants as $merchant)
                                                        <option value="{{$merchant->id}}" {{ in_array($merchant->id, (old('merchant') ?? [])) ? 'selected' : ''}}>{{$merchant->id}}. {{$merchant->name}}</option>
                                                    @endforeach
                                                </select>
                                                @error('merchant')
                                                <label class="text-danger">{{ $message }}</label>
