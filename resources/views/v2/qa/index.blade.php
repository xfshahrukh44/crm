                                ...
                                <div class="list-0f-head for-invoice-listing table-responsive">
                                    <div class="row text-left pr-3 pb-2">
                                        <div class="col-md-6 m-auto d-flex justify-content-start pt-2">
                                            <h1 style="font-weight: 100;">QA</h1>
                                        </div>
                                        <div class="col-md-6 m-auto d-flex justify-content-end">
                                            <a href="{{route('v2.users.qa.create')}}" class="btn btn-sm btn-success">
...
{{--                                    <div class="search-invoice">--}}
                                    <form class="search-invoice" action="{{route('v2.users.qa')}}" method="GET">
...
{{--                                                    </td>--}}
                                                    ...
                                                    <td style="position: relative;">
                                                        <a href="{{ route('v2.users.qa.edit', $user->id) }}" class="badge bg-primary badge-icon badge-sm text-white p-2">
