            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 form-group mb-3">
                        ...
                        <input class="form-control" name="business_email_address" id="business_email_address" type="email" value="{{ old('business_email_address', $smm_form->business_email_address) }}" />
                    </div>
                    <div class="col-md-4 form-group mb-3">
                        <label for="business_phone_number">Business Phone Number</label>
                        <input class="form-control" name="business_phone_number" id="business_phone_number" type="text" value="{{ old('business_phone_number', $smm_form->business_phone_number) }}"/>
                    </div>
                    <div class="col-md-4 form-group mb-3">
                        <label for="business_mailing_address">Business Mailing Address ( Verification Purposes )</label>
                        <input class="form-control" name="business_mailing_address" id="business_mailing_address" type="email" value="{{ old('business_mailing_address', $smm_form->business_mailing_address) }}"/>
                    </div>
                    <div class="col-md-4 form-group mb-3">
                        <label for="business_website_address">Business Website Address (URL)</label>
                        <input class="form-control" name="business_website_address" id="business_website_address" type="text" value="{{ old('business_website_address', $smm_form->business_website_address) }}"/>
                    </div>
                    <div class="col-md-4 form-group mb-3">
                        <label for="business_working_hours">Business Working Hours</label>
                        <input class="form-control" name="business_working_hours" id="business_working_hours" type="text" value="{{ old('business_working_hours', $smm_form->business_working_hours) }}"/>
                    </div>
                    <div class="col-md-12 form-group mb-3">
                        <label for="business_location">Business Location</label>
                        <input class="form-control" name="business_location" id="business_location" type="text" value="{{ old('business_location', $smm_form->business_location) }}"/>
                    </div>
                    <div class="col-md-12 form-group mb-3">
                        <label for="business_category">Business Category/Industry (Real Estate, Education, IT, Retail etc)</label>
                        <textarea class="form-control" name="business_category" id="business_category">{{ old('business_category', $smm_form->business_category) }}</textarea>
                    </div>
