            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 form-group mb-3">
                        ...
                        <input class="form-control" name="slogan" id="slogan" type="text" placeholder="Enter Slogan/Tagline" value="{{ old('slogan', $logo_form->slogan) }}"/>
                    </div>
                    <div class="col-md-12 form-group mb-3">
                        <label for="business">Describe your business / service / organization</label>
                        <textarea class="form-control" name="business" id="business" rows="5">{{ old('business', $logo_form->business) }}</textarea>
                    </div>
                </div>
            </div>
        </div>
