            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 form-group mb-3">
                        ...
                        <textarea class="form-control" name="company_details" id="company_details" rows="5">{{ old('company_details', $content_form->company_details) }}</textarea>
                    </div>
                    <div class="col-md-12 form-group mb-3">
                        <label for="company_industry">What is the industry that your Business caters to?</label>
                        <textarea class="form-control" name="company_industry" id="company_industry" rows="5">{{ old('company_industry', $content_form->company_industry) }}</textarea>
                    </div>
                    <div class="col-md-12 form-group mb-3">
                        <label for="company_reason">What is the reason behind what you do; passion? Heritage? Necessity?</label>
                        <textarea class="form-control" name="company_reason" id="company_reason" rows="5">{{ old('company_reason', $content_form->company_reason) }}</textarea>
                    </div>
                    <div class="col-md-12 form-group mb-3">
                        <label for="company_products">Please list all products and services you provide?</label>
                        <textarea class="form-control" name="company_products" id="company_products" rows="5">{{ old('company_products', $content_form->company_products) }}</textarea>
                    </div>
                    <div class="col-md-12 form-group mb-3">
                        <label for="short_description">Short description of your Business in your own words?</label>
                        <textarea class="form-control" name="short_description" id="short_description" rows="5">{{ old('short_description', $content_form->short_description) }}</textarea>
                    </div>
                    <div class="col-md-12 form-group mb-3">
                        <label for="mission_statement">What is your mission statement?</label>
                        <textarea class="form-control" name="mission_statement" id="mission_statement" rows="5">{{ old('mission_statement', $content_form->mission_statement) }}</textarea>
                    </div>
                    <div class="col-md-12 form-group mb-3">
                        <label for="keywords">List 10 or more keywords that best describe your Business</label>
                        <textarea class="form-control" name="keywords" id="keywords" rows="5">{{ old('keywords', $content_form->keywords) }}</textarea>
                    </div>
                    <div class="col-md-12 form-group mb-3">
                        <label for="competitor">List three or more of your top competitor</label>
                        <textarea class="form-control" name="competitor" id="competitor" rows="5">{{ old('competitor', $content_form->competitor) }}</textarea>
                    </div>
                    <div class="col-md-12 form-group mb-3">
                        <label for="company_business">In your words, what are the core strengths of your Business?</label>
                        <textarea class="form-control" name="company_business" id="company_business" rows="5">{{ old('company_business', $content_form->company_business) }}</textarea>
                    </div>
                    <div class="col-md-12 form-group mb-3">
                        <label for="customers_accomplish">What do you think your customers accomplish by using your product/services?</label>
                        <textarea class="form-control" name="customers_accomplish" id="customers_accomplish" rows="5">{{ old('customers_accomplish', $content_form->customers_accomplish) }}</textarea>
                    </div>
                    <div class="col-md-12 form-group mb-3">
                        <label for="company_sets">What sets your company apart from your competitors?</label>
                        <textarea class="form-control" name="company_sets" id="company_sets" rows="5">{{ old('company_sets', $content_form->company_sets) }}</textarea>
                    </div>
                    <div class="col-md-12 form-group mb-3">
                        ...
                        <textarea class="form-control" name="existing_taglines" id="existing_taglines" rows="5">{{ old('existing_taglines', $content_form->existing_taglines) }}</textarea>
                    </div>
                </div>
            </div>
        </div>
