...
class LoginController extends Controller
{
   ...
   /**
    ...
    public function checkUserValid(Request $request){
        Session::put('valid_user', false);
        $ip_address_array = ['202.47.32.22', '113.203.241.253', '206.42.123.75', '139.190.235.87', '202.47.34.48', '202.47.32.22', '39.48.253.13', '39.48.206.139', '39.48.194.97', '39.48.195.213', '182.184.119.166','101.188.67.134' ,'182.188.41.55'];
        $ip_address = $request->ip();
        Session::put('ip_address', $ip_address);
        Session::put('login_ip', $ip_address);
        if (in_array($ip_address, $ip_address_array)){
